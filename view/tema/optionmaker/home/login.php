    ...
    <div class="container" style="margin-top: 20vh">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-4 col-lg-4 offset-md-4 offset-lg-4 text-center white-panel p-4">
                <form action="${baseUri}/auth/eleitor" method="post">
                    <h6 class="text-danger"><img src="${baseUri}/media/default/logo.png" alt="Logo Option Maker"> OptionMaker</h6>
                    <h5 class="text-danger"><b>Sistema de Eleição</b></h5>

                    <input type="text" class="form-control" name="login" placeholder="GEN:">
                    <input type="password" class="form-control mt-2" name="senha" placeholder="SENHA:">
                    <small>(Ano de admissão + 4 primeiros digitos do CPF )</small>
                    <button class="btn btn-red mt-2 btn-block">Iniciar</button>
                </form>
            </div>
        </div>
    </div>
